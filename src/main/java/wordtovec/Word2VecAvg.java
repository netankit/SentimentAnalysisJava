 ...
 *
 */
public class Word2VecAvg {

	public static void main(String[] args) throws IOException {
		if (args.length != 4) {
			System.out
					.println("Usage: java -jar Word2VecAvg inputfile outputfile numberofTokens numberofVectors");
			System.exit(0);
		}
		System.out
				.println("Starting to compute averages of word2vec components....");
